...
Project Workflow is an approval-gated Codex plugin for complex software projects. It separates planning from implementation, persists project state in the repository, and prevents a newly generated plan from silently continuing into code changes.
...
4. execute tasks, test, review, and write a delivery report;
...
The state helper is located at `plugins/project-workflow/scripts/workflow_state.py`.
